 ...
 * 链路追踪上下文
 * <p>
 * 用于在线程中存储和获取 TraceId，适用于 Servlet 环境
 * </p>
 *
 * <h3>线程支持：</h3>
 * <ul>
 ...
 *   <li>注意：在线程池中使用时需要手动传递（因为线程复用）</li>
 * </ul>
 *
 * @author JNet Team
 * @version 4.0 (支持子线程继承)
...
public class TraceContext {
     ...
     * <p>
     * ⚠️ 使用 InheritableThreadLocal 支持父子线程传递
     * </p>
     */
     ...
     * 设置 TraceId
     * <p>
     * 将 TraceId 存储到 ThreadLocal 中，供当前线程使用
     * </p>
     *
    ...
    public static void setTraceId(String traceId) {
        if (StringUtils.hasText(traceId)) {
            ...
            log.debug("TraceId set in ThreadLocal: {}", traceId);
        }
    }
     ...
     * <p>
     * 优先从 ThreadLocal 获取，不存在则生成新的 TraceId
     * </p>
     *
     * @return TraceId
     */
    ...
    public static void clear() {
        ...
        log.debug("ThreadLocal TraceId cleared");
    }
}
